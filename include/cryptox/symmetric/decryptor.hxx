...
namespace cryptox {
	...
	class decryptor : public basic_endec<Algorithm, EVP_DecryptInit_ex, EVP_DecryptUpdate, EVP_DecryptFinal_ex> {
		typedef basic_endec<Algorithm, EVP_DecryptInit_ex, EVP_DecryptUpdate, EVP_DecryptFinal_ex> base_type;
	public:
